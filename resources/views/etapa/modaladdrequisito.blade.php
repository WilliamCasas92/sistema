    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Definición de nuevo Requisito para: <span id="modalRequisitoNombre"></span></h4>
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" id="modalRequisitoForm" method="post" >
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-4" for="InputName" required>Nombre del Requisito:</label>
                        <div class="col-md-5">
                            <input type="text" name="nombre" class="form-control" placeholder="Escriba aquí el nombre del Requisito" required>
                        </div>
                    </div>
                    <div class="form-group">
                        @php
                        ...
                        @endphp
                        <label for="sel" class="control-label col-md-4" for="InputName">Seleccione tipo de Requisito:</label>
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-4" for="InputActivo">Requisito Obligatorio:</label>
                        <div class="col-md-4">
                            <div class="checkbox">
